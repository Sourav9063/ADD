...
- `for d in skills/agent-driven-development/* skills/agent-driven-review/* skills/misc/writing-agent-guidance; do diff -ru "$d" ".agents/skills/$(basename "$d")"; done`: maintainer-only check that installed ADD skills match `skills/` (repeat for `.claude/skills`).
